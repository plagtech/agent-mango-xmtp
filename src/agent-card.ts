export const AGENT_CARD = {
  ...
  skills: [
    ...
    },
    {
      ...
      tags: ["payments", "batch", "multi-chain"],
      examples: ["Send 10 USDC each to 5 addresses on Base"]
    },
    {
      id: "spraay-x402",
      name: "x402 Paid API",
      description: "Access Spraay x402 payment gateway endpoints. 9 paid endpoints for AI agent micropayments on Base mainnet.",
      tags: ["x402", "micropayments", "api", "base"],
      examples: ["Query Spraay x402 gateway for batch payment pricing"]
    }
  ],
